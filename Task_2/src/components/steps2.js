      ...
      <div className="steps2-max-width thq-section-max-width">
        <div className="steps2-container2 thq-grid-2">
          <div className="steps2-section-header">
            ...
            Отримати сайт дуже просто
            </h2>
            <p className="thq-body-large">
            Для цього потрібно слідувати інструкції праворуч.
            </p>
          </div>
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Крок 1: Консультація</span>
                  </Fragment>
                )}
              </h2>
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Крок 2: Дизайн</span>
                  </Fragment>
                )}
              </h2>
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Крок 3: Розробка</span>
                  </Fragment>
                )}
              </h2>
              <span className="steps2-text20 thq-body-small">
                {props.step3Description ?? (
                  <Fragment>
                    ...
                    Наші фахівці реалізують проект з урахуванням всіх деталей.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Крок 4: Запуск</span>
                  </Fragment>
                )}
              </h2>
